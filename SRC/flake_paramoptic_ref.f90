...
TYPE (opticpar_medium), PARAMETER ::                           & 
  opticpar_water_ref = opticpar_medium(1,                      & ! Water (reference)
    ...
    (/0.7_ireals, (1.E+10_ireals,i=2,nband_optic_max)/))      , &
  opticpar_water_ref_2 = opticpar_medium(1,                      & ! Water (reference)
    (/1._ireals, (0._ireals,i=2,nband_optic_max)/),            &
  ...
  opticpar_water_trans_2 = opticpar_medium(1,                    & ! Transparent Water (one-band)
    (/1._ireals, (0._ireals,i=2,nband_optic_max)/),            &
    (/3.5_ireals, (1.E+10_ireals,i=2,nband_optic_max)/))    , &
